...
if (sessionStorage.getItem("selectedNavItem") === "home") {
    navbarItems[0].style.backgroundColor = "lightseagreen";
    dropItems[0].style.backgroundColor = "lightseagreen";
}
else if (sessionStorage.getItem("selectedNavItem") === "project") {
    navbarItems[1].style.backgroundColor = "lightseagreen";
    dropItems[1].style.backgroundColor = "lightseagreen";
}
else if (sessionStorage.getItem("selectedNavItem") === "about") {
    navbarItems[2].style.backgroundColor = "lightseagreen";
    dropItems[2].style.backgroundColor = "lightseagreen";
}
else if (sessionStorage.getItem("selectedNavItem") === "login") {
    navbarItems[3].style.backgroundColor = "lightseagreen";
    dropItems[3].style.backgroundColor = "lightseagreen";
}